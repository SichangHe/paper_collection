...
Latest updates: [hps://dl.acm.org/doi/10.1145/2815675.2815717](https://dl.acm.org/doi/10.1145/2815675.2815717)

## Analyzing the Performance of an Anycast CDN

MATT [CALDER](https://dl.acm.org/doi/10.1145/contrib-82658961057), University of Southern [California,](https://dl.acm.org/doi/10.1145/institution-60029311) Los Angeles, CA, United States [ASHLEY](https://dl.acm.org/doi/10.1145/contrib-99659400487) FLAVEL, Microso [Corporation,](https://dl.acm.org/doi/10.1145/institution-60026532) Redmond, WA, United States ETHAN B [KATZ-BASSETT](https://dl.acm.org/doi/10.1145/contrib-81319494709), University of Southern [California,](https://dl.acm.org/doi/10.1145/institution-60029311) Los Angeles, CA, United States RATUL [MAHAJAN](https://dl.acm.org/doi/10.1145/contrib-81100330255), Microso [Corporation,](https://dl.acm.org/doi/10.1145/institution-60026532) Redmond, WA, United States JITENDRA [DATTATRAYA](https://dl.acm.org/doi/10.1145/contrib-81100067455) PADHYE, Microso [Corporation,](https://dl.acm.org/doi/10.1145/institution-60026532) Redmond, WA, United States

Open Access [Support](https://libraries.acm.org/acmopen) provided by: [University](https://dl.acm.org/doi/10.1145/institution-60029311) of Southern California Microso [Corporation](https://dl.acm.org/doi/10.1145/institution-60026532)

![](_page_0_Picture_9.jpeg)

PDF Download 2815675.2815717.pdf 13 January 2026 Total Citations: 111 Total Downloads: 980

Published: 28 October 2015

[Citation](https://dl.acm.org/action/exportCiteProcCitation?dois=10.1145%2F2815675.2815717&targetFile=custom-bibtex&format=bibtex) in BibTeX format

IMC '15: Internet [Measurement](https://dl.acm.org/conference/imc) [Conference](https://dl.acm.org/conference/imc) *October 28 - 30, 2015 Tokyo, Japan*
...
Copyright is held by the owner/author(s). Publication rights licensed to ACM. ACM 978-1-4503-3848-6/15/10 ...\$15.00.
...
<sup>1</sup>No geolocation database is perfect. A fraction of very long client-to-front-end distances may be attributable to bad client geolocation data.
...
We saw in this section that most clients show high front-endaffinity, that is, they continue going to the same front-end over time. For the clients that do switch front-ends, there is a long tail of distance between a client and switched pairs of front-ends.
...
<sup>2</sup>We cannot make predictions at finer timescales, as our sampling rate was limited due to engineering issues.
...
In this paper we studied the performance of a large anycastbased CDN, and evaluated whether it could be improved by using a centralized, DNS-based solution. We found that anycast usually performs well despite the lack of precise control, but that it directs ≈ 20% of clients to a suboptimal front-end. We demonstrated that a simple prediction scheme may allow DNS redirection to improve performance for some of the clients that see poor anycast performance.
