...
Inter Domain Routing, BGP; Internet Routing Registries (IRR) Evolution 201attributes are used 3) Using only limited RPSL constructs e.g. Autumn, Inetnum, etc. There is no tool available at this time which could able to infer the complete policy of an Autonomous System(AS).By complete policy we mean,AS registered policy in the IRR which can also be confirmed from its neighbors ASes records in IRR.
...
2. We are working on to follow a Community-centric useful an up-to-date registry can be in solving the problems of Internet Routing? If RIPE NCC registry is good than Why it's not comparable to BGP traces. How can than we say that it is good? Why do we find topology differences between BGP and IRR as reported in [7]?
...
Table1; shows the snapshot of most populated registries from RADb and RIPE NCC of two months i.e. March 2006/March 2010.RIPE NCC has \(>\)3M objects and RADb has \(>\)300K objects. We are not reporting here the RPSL objects like mmter, person, role as they are mostly required to authenticate while registering data into IRR. Some of our findings are 1)RIPE NCC is the mostly populated registry as well as usage of different RPSL constructs while other registries still use only partial set of RPSL constructs 2).autnum and route objects are mostly published objects in IRR so any scheme which relies on using other objects has limited success in terms of using published IRR datasets.3) Verio has changed its name to NTTCOM and contains around 77K objects which clearly shows that policies set by service providers can push customers to enter data into IRR. Figure 1 and Figure 2 shows the evolution of different RPSL objects in our observed period of March 2006- June 2008.

Figure 1 to Figure 3; shows the count of number of total RPSL objects existence in IRR.As it can be seen that operators mostly registered object registered in IRR's are Inetnum, Route and AS

\begin{table}
\begin{tabular}{|l|c|c|c|c|c|c|c|c|c|c|c|c|c|} \hline \multicolumn{1}{|c|}{\multirow{2}{*}{**APNIC**}} & \multicolumn{2}{c|}{**RIPE NCC**} & \multicolumn{2}{c|}{**ARIN**} & \multicolumn{2}{c|}{**Bell**} & \multicolumn{2}{c|}{**Level3**} & \multicolumn{2}{c|}{**RADb**} & \multicolumn{2}{c|}{**NTTCOM**} \\ \hline  & **03/2006** & **03/2010** & **03/2006** & **03/2010** & **03/2006** & **03/2010** & **03/2006** & **03/2010** & **03/2006** & **03/2010** & **03/2006** & **03/2010** \\ \hline
**AUT-NUM** & 495 & 5,420 & 11,468 & 19,905k & 324 & 1014 & 74 & 92 & 75 & 245 & 608 & 3,233 & 498 & 545 \\ \hline
**ROUTE** & 16 & 50,779 & 55,793 & 119.35\% & 194 & 10959 & 26049 & 29463 & 498 & 76,325 & 121 & 2,98,37 & 26229 & 75,156 \\ \hline
**INETNUM** & 0 & 0 & 1580686 & 2911.238k & 0 & 461 & 0 & 0 & 0 & 0 & 0 & 0 & 0 \\ \hline
**INETNUM** & 0 & 0 & 10,986 & 35.30\% & 0 & 1 & 0 & 0 & 0 & 0 & 0 & 0 & 22 \\ \hline
**AS-SET** & 2 & 198 & 5172 & 9.42\% & 14 & 298 & 49 & 50 & 2 & 188 & 26 & 1,666 & 340 & 423 \\ \hline
**FILTER-SET** & 0 & 0 & 63 & 0.096k & 0 & 0 & 0 & 0 & 0 & 0 & 12 & 0 & 0 \\ \hline
**PEEING-SET** & 0 & 3 & 143 & 0.171k & 0 & 0 & 0 & 0 & 0 & 0 & 13 & 0 & 0 \\ \hline
**ROUTE-SET** & 4 & 43 & 578 & 0.983k & 6 & 208 & 3 & 3 & 10 & 1658 & 35 & 1654 & 228 & 234 \\ \hline
**RTR-SET** & 0 & 0 & 11 & 0.014k & 0 & 0 & 0 & 0 & 0 & 0 & 9 & 0 & 0 \\ \hline
**KEY-CERT** & 7 & 8 & 3299 & 6.071k & 0 & 0 & 0 & 0 & 0 & 41 & 248 & 21 & 653 \\ \hline
**ROUTE6** & 0 & 61 & 219 & 0 & 0 & 10 & 0 & 92 & 0 & 10 & 0 & 637 & 54 & 83 \\ \hline
**INET-RTR** & 0 & 0 & 100 & 0.114k & 0 & 0 & 0 & 0 & 0 & 2 & 0 & 95 & 1 & 1 \\ \hline
**Total** & **514** & **\textgreater{}56K** & **\textgreater{}1.6M** & **\textgreater{}3M** & **538** & **\textgreater{}12K** & **\textgreater{}54k** & **\textgreater{}29K** & **585** & **\textgreater{}78c** & **831** & **\textgreater{}300K** & **\textgreater{}27K** & **\textgreater{}77K** \\ \hline \end{tabular}
\end{table}
...
* [2] Blunk L., Damas,J.,Parent,F. and Robachevsky, A.: Routing Policy Specification Language next generation (RPSLng). IETF RFC 4012, 2005.
...
* [6] RIPE Document 201, 2001.[RRCC. [http://www.ripe.net/projects/rrcc/](http://www.ripe.net/projects/rrcc/)]
* [7] Mahadevan, P. et.al The Internet AS-Level Topology: Three Data Sources and One Definitive Metric. ACM SIGCOMM Computer Communication Review, 2006.
* [8] Zhang,B.,Liu,R.,Massey,D. and Zhang,L. : Collecting the Internet AS-level topology. ACM SIGCOMM CCR, 2005.
* [9] Siganos,G. and Faloutsos,M. : Analyzing BGP Policies: Methodology and Tool. In IEEE INFOCOM, 2004.
* [10] Siganos,G. and Faloutsos,M. : A Blueprint for Improving the Robustness of Internet Routing, Security '06, 2006
* [11] Sriram,K.,Borchert,O.,Kim,O.,Gleichmann,P., Montgomery.D : A Comparative Analysis of BGPAnomaly Detection and Robustness Algorithms, Cybersecurity Applications & Technology Conference for Homeland Security(CATCH), p.25-38, March 03-04, 2009
* [12][http://www.inea.org/numbers/](http://www.inea.org/numbers/)
* [13][http://www.ripe.net/](http://www.ripe.net/)
* [14][http://www.irr.net/docs/list.html](http://www.irr.net/docs/list.html)
* [15] RADB db. [ftp://ftp.radb.net/radb/dbase/](ftp://ftp.radb.net/radb/dbase/)
* [16] RIPE db. [ftp://ftp.ripe.net/ripe/dbase/](ftp://ftp.ripe.net/ripe/dbase/)
* [17] IRRd. [http://www.irrd.net/](http://www.irrd.net/)
* [18][http://www.isc.org/index.pl?/sw/IRRTooISet/](http://www.isc.org/index.pl?/sw/IRRTooISet/)
* [19][http://www.routeviews.org/](http://www.routeviews.org/)
* [20][http://www.ripe.net/projects/ris/](http://www.ripe.net/projects/ris/)
* [21][http://irl.cs.ucla.edu/topology/](http://irl.cs.ucla.edu/topology/)
* [22] Worldwide Infrastructure Security Report Arbor Networks, 2009 from [http://arbrometworks.com](http://arbrometworks.com)
* [23][http://assert.carbonetworks.com/2008/05/using-rpki-to-construct-validated-irr-data/](http://assert.carbonetworks.com/2008/05/using-rpki-to-construct-validated-irr-data/)
* [24][http://www.ietf.org/dyn/wg/charter/sidr-charter.html](http://www.ietf.org/dyn/wg/charter/sidr-charter.html)
* [25] IRL UCLA topology Dataset from [http://irl.cs.ucla.edu/topology/](http://irl.cs.ucla.edu/topology/) 
